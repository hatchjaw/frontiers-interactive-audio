...
%        keyword
    ...
    Word-count: 11619; tables: 1; figures: 13.
...
%    stand as topics for future research.
%    From the level of audio hardware and driver software, to audio host and
%    audio buffer behaviour, to network QoS and the performance of network
%    switches, to the behaviour of the hardware platform, its processor and audio
%    codec, plus its software libraries \textemdash{} much that is typically
%    taken for granted in the development of embedded systems, and audio and
%    networking applications, calls for deeper investigation.
