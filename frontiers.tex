...
%        keyword
    ...
    Selecting a low-cost hardware platform, using ubiquitous computer networking
    technologies, and keeping the overall design of the system as simple as
    possible, it is hoped that this work could lead to a lowering of the barrier
    to entry of the creation of large scale spatial and immersive audio
    installations.
    With a view to optimising accessibility and interoperability with existing
    audio tools, the server component of the proposed networked audio system is
    encapsulated in an audio plugin suitable for use in a Digital Audio
    Workstation (DAW)\@.
...
%    TODO: maybe reinstate this paragraph somewhere?
...
%    and describe our ambitions for future work.
    ...
    \dots [Or here, to ease the reader in.]
