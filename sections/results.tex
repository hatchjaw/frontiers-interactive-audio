...
the system described and developed in chapter~\ref{sec:method} in terms of
...
that elapse between transmission and reception (see \figref{fig:test-signal}).
...
\paragraph{Clock Drift/Skew} A unipolar sawtooth wave of unit amplitude
...
restrictions posed by the MTU (see section~\ref{subsec:anatomy-of-a-datagram}).
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{figures/wgn_specgram_16_32_lo}
    \caption{
...
Clock drift measurements in Figures~\ref{fig:rtt-drift-16}
and~\ref{fig:rtt-drift-32} exhibit comparable trends.
