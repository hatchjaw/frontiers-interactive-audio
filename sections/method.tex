...
approach, as described by Lopez-Lezcano~\citep{lopez-lezcano_jack_2012}, may be
a viable one.
...
\todo[inline]{Describe number of channels that can be sent at bufsize 16 and 32}
...
of such additional memory for rapid access, such as is called for in an audio
DSP algorithm, remains to be investigated.
