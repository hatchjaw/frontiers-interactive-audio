...
% The decision to pursue a \textit{no-protocol} approach \textemdash{} or rather
% to design a new protocol for the system under development \textemdash{} was not
% taken lightly.

\todo[inline]{Non-sequitur; fix this}
...
~\citep{noauthor_socket2_nodate} to which a type \textemdash{}
...
\todo[inline]{Reference these figures in the text or get rid.}
...
\secref{subsec:hardware-platforms}) was used to ensure that they were all
