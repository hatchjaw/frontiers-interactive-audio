...
\todo[inline]{General introduction to the development of the system.}

\subsection{The Networked Audio Server}\label{subsec:the-networked-audio-server}

TCP is, as described in section~\ref{subsubsec:protocols-systems}, a
...
described in section~\ref{subsec:distributed-computing}.
...
and, as described in section~\ref{subsec:client-sync}, makes adjustments to its
audio clock.
