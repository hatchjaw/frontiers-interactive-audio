...
Indeed, the WFS system at TU Berlin described in \secref{subsubsec:spatial-sota}
is in fact a distributed system, its 800+ output channels being driven by a
cluster of fifteen Linux computers producing 56 output channels
each~\citep{baalman_renewed_2007}.
